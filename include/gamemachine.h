...
{
	public:
		GameMachine(); ///< TODO REMEMBER TO CALL THIS FROM CHILD CLASS!! IMPORTANT STUFF HAPPENS HERE
		...
		BITMAP *doubleBuffer; ///< double buffer to draw without flicker, managed internally
};
